...
public class Page {
	...
	public void assertEquals(String _expected, String _actual) {

		Assert.assertEquals(_expected, _actual);
	}

	public void assertTrue(boolean _condition, String _message) {

		Assert.assertTrue(_condition, _message );
	}

	public void assertFalse(boolean _condition, String _message) {

		Assert.assertFalse(_condition, _message );
	}
}
